...
import type { ThemeColorPresets } from "@/contexts/settings/settings-context";

export function createPresets(preset: ThemeColorPresets) {
...
export function getPrimary(preset: ThemeColorPresets) {
  return {
    default: primary,
    cyan,
    purple,
